...
public class Parser
{
    ...
    Stack<int> PilaOperandos = new Stack<int>();			//Pila de operandos para la generación de cuÃ¡druplos
    Stack<int> PTipos = new Stack<int>();					//Pila de tipos para la validación de semÃ¡ntica
    ...
    /// <summary>
    /// Método que sirve para intentar generar un cuÃ¡druplo de las expresiones, revisa que se
    /// pueda realizar la operación y si no, manda un error de semÃ¡ntica. 
    /// </summary>
    private void tryToGenerateQuadruple()
    {
        ...
        {
            //Se genera un error de semÃ¡ntica y se termina la ejecución
    ...
    void PLearning()
    {
        ...
        procedureList.Add(t.val);										//Se aÃ±ade también a la lista de procedimientos
        ...
        PSaltos.Push(quadruples.Count);									//AÃ±ade en la pila de saltos la posición en donde estarÃ¡ el goto al main
    ...
    void vars()
    {
        ...
        if (la.kind == 1)
        {
            ...
            else
            {
                ...
                //Se aÃ±ade la nueva variable a la tabla de variables del procedimiento en cuestión
    ...
    void ciclowhile()
    {
        ...
        else
        {
            ...
            PSaltos.Push(quadruples.Count);
            //Se genera el cuÃ¡druplo del GotoF con el resultado de la expresión
        ...
        //Se genera un nuevo cuÃ¡druplo Goto para regresar antes de la expresión y se aÃ±ade a la lista de cuÃ¡druplos
        insertQuadruple(OperationCode.Goto, -1, -1, retorno);

        //Se rellena el cuadruplo del GotoF con la posición del siguiente cuÃ¡druplo
    ...
    void ciclofor()
    {
        ...
        if (tipoDer == tipoIzq)
        {
            //Se genera un nuevo cuÃ¡druplo para realizar la asignación y se mete a la lista	
    ...
    void condicion()
    {
        ...
        else
        {
            ...
            int res = PilaOperandos.Pop();
            //Se aÃ±ade a la pila de saltos la posición del GotoF
            PSaltos.Push(quadruples.Count);
